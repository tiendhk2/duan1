...
public class Adapter_DangGiaoCuaKhachHang extends RecyclerView.Adapter<Adapter_DangGiaoCuaKhachHang.ViewHolder> {
    ...
    public Adapter_DangGiaoCuaKhachHang(ArrayList<HoaDon> list, Context context, HoaDonDAO hoaDonDAO) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_recycledanggiaocuakhachhang, parent, false);
